...
const bugCommand = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(
            ...
            .setChoices(
                ...
                { name: '/debt command', value: 'debt' },
                { name: '/debts command', value: 'debts' },
                { name: '/tab command', value: 'tab' }
            )
            .setRequired(true))
        .addStringOption(
    ...
    async execute (interaction) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setThumbnail('https://raw.githubusercontent.com/edwardshturman/receipt-bot/master/assets/receipt-logo.png')
            .setTimestamp();
